...
games.append(VolleyGame({
    ...
    'full': True,
    'serve': True,
    'lineup': [23, 38, 3, 29, 00, 11],
    'team_scores': [1, 'R', 2, 3, 4, 'R', 5, 6, 7, 8, 9, 10, 11, 12, 'R', 13, 'R', 14, 'R', 15, 'R', 16, 17, 18, 19, 20, 'R', 21, 'R', 22, 'R', 23, 'R', 24, 25, 'X'], #pylint: disable=line-too-long
    'oppo_scores': [1, 2, 3, 4, 5, 6, 'R', 7, 8, 9, 'R', 10, 11, 12, 'R', 13, 14, 'R', 15, 16, 'R', 17, 'R', 18, 'R', 19, 'R', 20, 'R', 21, 'R'] #pylint: disable=line-too-long
}))
games.append(VolleyGame({
    'match': 3,
    'game': 2,
    'full': True,
    'serve': False,
    'lineup': [93, 9, 25, 45, 3, 30],
    'team_scores': [1, 'R', 2, 3, 'R', 4, 'R', 5, 'R', 6, 'R', 7, 'R', 8, 'R', 9, 10, 'R', 11, 'R'], #pylint: disable=line-too-long
    'oppo_scores': [1, 2, 3, 4, 'R', 5, 'R', 6, 7, 8, 9, 10, 'R', 11, 12, 13, 'R', 14, 'R', 15, 'R', 16, 17, 18, 19, 20, 'R', 21, 'R', 22, 23, 'R', 24, 'R', 25, 'X'] #pylint: disable=line-too-long
}))
games.append(VolleyGame({
    'match': 3,
    ...
    'full': True,
    'serve': True,
    'lineup': [38, 0, 29, 25, 11, 23],
    'team_scores': [1, 'R', 2, 3, 4, 5, 'R', 6, 'R', 7, 8, 9, 10, 11, 12, 'R', 13, 14, 'R', 15, 16, 17, 18, 19, 20, 21, 22, 23, 'R', 24, 25, 'X'], #pylint: disable=line-too-long
    'oppo_scores': [1, 'R', 2, 'R', 3, 'R', 4, 5, 'R', 6, 7, 'R', 8, 9, 'R'] #pylint: disable=line-too-long
}))
